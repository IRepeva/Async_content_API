...
#                                 make_get_request):
#     person_num = 0
#     url = URL_PREFIX + f"/{films_data[person_num]['id']}"
#
...
#     assert response.body == films_data[person_num]
#
#     # getting data from cache
#     # await elastic.clear_all()
#     #
#     # response = await make_get_request(url)
#     cache_key = get_cache_key({'film_id': films_data[person_num]['id']})
#     cache_result = redis_client.get(cache_key)
#
#     assert cache_result == films_data[person_num]
#
#
